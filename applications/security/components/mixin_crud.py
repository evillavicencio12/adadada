...
class PermissionMixin(object):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            if current_url_name == 'home' and 'group_id' not in request.session:
                messages.error(request, 'No hay un grupo seleccionado en la sesión.')
                return super().get(request, *args, **kwargs)  # Continúa sin redirigir
