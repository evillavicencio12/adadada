...
# Cuando se utiliza un fk
# modulos = Module.objects.select_related('menu')
# for modulo in modulos: print(modulo.name, modulo.id, modulo.menu)

# Cuando se utiliza un m2m
# modulos = Module.objects.prefetch_related('permissions')
# for modulo in modulos: print(modulo.name, modulo.id, [mod.name for mod in modulo.permissions.all()])
# for modulo in modulos: print(modulo.name, modulo.id, [perm.codename for perm in modulo.permissions.all()])