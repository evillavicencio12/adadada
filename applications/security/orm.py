...
# from applications.security import orm
...
menu5 = Menu.objects.create(
       name='Menu de Seguridad',
...
seguridad = Module.objects.create(
    url='seguridad/',
    name='Seguridad',
    menu=menu5,
...
seguridad_view = Permission.objects.get_or_create(codename='view_seguridad', name='Can view Seguridad', content_type=ContentType.objects.get_for_model(seguridad))[0]
seguridad_add = Permission.objects.get_or_create(codename='add_seguridad', name='Can add Seguridad', content_type=ContentType.objects.get_for_model(seguridad))[0] 
seguridad_change = Permission.objects.get_or_create(codename='change_seguridad', name='Can change Seguridad', content_type=ContentType.objects.get_for_model(seguridad))[0]
seguridad_delete = Permission.objects.get_or_create(codename='delete_seguridad', name='Can delete Seguridad', content_type=ContentType.objects.get_for_model(seguridad))[0]
...
seguridad.permissions.add(seguridad_view, seguridad_add, seguridad_change, seguridad_delete)

gpr = GroupModulePermission.objects.create(group=group_medicos, module=seguridad)
gpr.permissions.add(seguridad_view, seguridad_add, seguridad_change, seguridad_delete)
