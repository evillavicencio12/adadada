...
class GastoMensualListView(LoginRequiredMixin, PermissionRequiredMixin, ListViewMixin, ListView):
    model = GastoMensual
...
class GastoMensualCreateView(LoginRequiredMixin, PermissionRequiredMixin, ListViewMixin, CreateView):
    model = GastoMensual
...
class GastoMensualUpdateView(LoginRequiredMixin, PermissionRequiredMixin, ListViewMixin, UpdateView):
    model = GastoMensual
    form_class = GastoMensualForm
    template_name = "core/gastomensual/gastomensual_form.html"
    success_url = reverse_lazy('core:gastomensual_list')
...
class GastoMensualDeleteView(LoginRequiredMixin, PermissionRequiredMixin, ListViewMixin, DeleteView):
    model = GastoMensual
