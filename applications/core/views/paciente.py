    ...
    try:
        ...
        for paciente in pacientes_query:
            ...
            for atencion in paciente.atenciones.all()[:10]:
                ...
                atencion_dict = {
                    'id': atencion.id,
                    'fecha_atencion_real': atencion.fecha_atencion_real.isoformat(),
...
@login_required
def paciente_search_view(request):
    return render(request, 'core/paciente/search.html')  # la ruta de tu template