...
class TipoGastoListView(LoginRequiredMixin, PermissionRequiredMixin, MixinCRUD, ListView):
    model = TipoGasto
...
class TipoGastoCreateView(LoginRequiredMixin, PermissionRequiredMixin, MixinCRUD, CreateView):
    model = TipoGasto
...
class TipoGastoUpdateView(LoginRequiredMixin, PermissionRequiredMixin, MixinCRUD, UpdateView):
    model = TipoGasto
    form_class = TipoGastoForm
    template_name = "core/tipogasto/tipogasto_form.html"
    success_url = reverse_lazy('core:tipogasto_list')
...
class TipoGastoDeleteView(LoginRequiredMixin, PermissionRequiredMixin, MixinCRUD, DeleteView):
    model = TipoGasto
