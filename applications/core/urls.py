...
from applications.core.views.empleado import EmpleadoCreateView, EmpleadoDeleteView, EmpleadoListView, EmpleadoUpdateView
...
urlpatterns = [
    ...
    path('empleados/<int:pk>/edit/', EmpleadoUpdateView.as_view(), name='empleado_update'),
