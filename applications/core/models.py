...
class ExamenLaboratorio(models.Model):
    ...
    def __str__(self):
        return f"{self.nombre_examen} - {self.paciente}"
...
class Ecografia(models.Model):
    ...
    descripcion = models.TextField()
    fecha_realizacion = models.DateField()
    imagen = models.ImageField(upload_to='ecografias/', null=True, blank=True)

    def __str__(self):
        return f"Ecografía de {self.paciente} ({self.fecha_realizacion})"
...
class Atencion(models.Model):
    ...
    def __str__(self):
        return f"Atención a {self.paciente} por {self.medico} el {self.fecha}"
...
class RecetaMedica(models.Model):
    ...
    def __str__(self):
        return f"Receta para {self.atencion}"