...
class AtencionAdmin(admin.ModelAdmin):
    list_display = ("paciente", "fecha_atencion_real", "es_control")
    list_filter = ("fecha_atencion_real", "es_control")
...
class PagoAdmin(admin.ModelAdmin):
    list_display = ("id", "atencion", "monto_total", "estado", "metodo_pago", "fecha_pago", "date_creation")
    list_filter = ("estado", "metodo_pago", "date_creation")
